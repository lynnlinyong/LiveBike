...
//        NSString *progressString = [NSString stringWithFormat:@"%.0f", _progress * 100.0];
        ...
        CGSize expectedSize = [_content sizeWithFont:font
                                               minFontSize:5.0
        ...
        if (actualFontSize < fontSize)
        {
            ...
            expectedSize = [_content sizeWithFont:font
                                            minFontSize:5.0
                                         actualFontSize:&actualFontSize
                                               forWidth:maximumSize.width
                                          lineBreakMode:NSLineBreakByWordWrapping];
        ...
        [_content drawAtPoint:origin forWidth:expectedSize.width withFont:font lineBreakMode:NSLineBreakByWordWrapping];
    }
